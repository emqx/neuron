...
void message_handle_write_handle(neu_plugin_t *              plugin,
                                 struct neu_parse_write_req *write_req);
void message_handle_get_tag_list_handle(neu_plugin_t *                 plugin,
                                        struct neu_parse_get_tags_req *req);
void message_handle_add_tag_handle(neu_plugin_t *                 plugin,
