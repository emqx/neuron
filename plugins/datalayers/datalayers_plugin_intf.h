...
#define NEU_METRIC_MAX_CACHED_QUEUE_SIZE_HELP "Max size of the cached message queue"
...
#define NEU_PLUGIN_UPDATE_MAX_CACHED_QUEUE_SIZE_METRIC(plugin, val) \
    NEU_PLUGIN_UPDATE_METRIC(plugin, NEU_METRIC_MAX_CACHED_QUEUE_SIZE, val, NULL)
