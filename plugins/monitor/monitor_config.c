...
static int make_event_topics(monitor_config_t *config, const char *prefix)
{
    ...
    neu_asprintf(&group_update_subscribe_topic, "%s/group/update/subscribe",
                 prefix);
...
error:
    free(groups_subscribe_topic);
    free(group_update_subscribe_topic);
    free(group_unsubscribe_topic);
    free(group_subscribe_topic);
    free(plugin_del_topic);
    free(plugin_add_topic);
    free(gtag_add_topic);
...
void monitor_config_fini(monitor_config_t *config)
{
    ...
    free(config->groups_subscribe_topic);
    free(config->group_update_subscribe_topic);
    free(config->group_unsubscribe_topic);
    free(config->group_subscribe_topic);
    free(config->plugin_del_topic);
    free(config->plugin_add_topic);
    free(config->gtag_add_topic);
