...
typedef enum msg_type {
	...
	MSG_CMD_START_NEURON,
	MSG_CMD_STOP_NEURON,
	MSG_TYPE_CMD_END,

	MSG_TYPE_CONFIG_START = 0x1000,
	MSG_CONFIG_SUB_NEURON_DRIVER = MSG_TYPE_CONFIG_START,
	MSG_CONFIG_INFO_STRING,
	MSG_TYPE_CONFIG_END,
	...
	MSG_DATA_NEURON_DRIVER = MSG_TYPE_DATA_START,
	MSG_TYPE_DATA_END,

	// User customer message types
	MSG_TYPE_VENDOR_START = 0x10000,
	MSG_TYPE_VENDOR_END,
