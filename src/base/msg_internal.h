...
#define NEU_REQRESP_TYPE_MAP(XX)                                               \
    ...
    XX(NEU_REQ_SERVER_CERT_SELF_SIGN, neu_req_server_cert_self_sign_t)         \
    XX(NEU_REQ_SERVER_CERT_UPLOAD, neu_req_server_cert_upload_t)               \
    XX(NEU_REQ_SERVER_CERT_INFO, neu_req_server_cert_data_t)                   \
    XX(NEU_RESP_SERVER_CERT_INFO, neu_resp_server_cert_data_t)                 \
    XX(NEU_REQ_SERVER_CERT_EXPORT, neu_req_server_cert_export_t)               \
    XX(NEU_RESP_SERVER_CERT_EXPORT, neu_resp_server_cert_export_t)             \
    XX(NEU_REQ_CLIENT_CERT_UPLOAD, neu_req_client_cert_upload_t)               \
    XX(NEU_REQ_CLIENT_CERT_DELETE, neu_req_client_cert_del_t)                  \
    XX(NEU_REQ_CLIENT_CERT_TRUST, neu_req_client_cert_trust_t)                 \
    XX(NEU_REQ_CLIENT_CERT_INFO, neu_req_client_cert_data_t)                   \
    XX(NEU_RESP_CLIENT_CERT_INFO, neu_resp_client_certs_data_t)                \
    XX(NEU_REQ_SERVER_SECURITY_POLICY, neu_req_server_security_policy_t)       \
    XX(NEU_REQ_SERVER_SECURITY_POLICY_STATUS,                                  \
       neu_req_server_security_policy_status_t)                                \
    XX(NEU_RESP_SERVER_SECURITY_POLICY_STATUS,                                 \
       neu_resp_server_security_policy_status_t)                               \
    XX(NEU_REQ_SERVER_AUTH_SWITCH, neu_req_server_auth_switch_t)               \
    XX(NEU_REQ_SERVER_AUTH_SWITCH_STATUS, neu_req_server_auth_switch_status_t) \
    XX(NEU_RESP_SERVER_AUTH_SWITCH_STATUS,                                     \
       neu_resp_server_auth_switch_status_t)                                   \
    XX(NEU_REQ_SERVER_AUTH_USER_ADD, neu_req_server_auth_user_add_t)           \
