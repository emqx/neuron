...
typedef enum {
    ...
    NEU_ERR_DEVICE_READ_FAILURE        = 3000,
    NEU_ERR_DEVICE_WRITE_FAILURE       = 3001,
    NEU_ERR_DEVICE_DISCONNECTED        = 3002,
    NEU_ERR_DEVICE_TAG_NOT_ALLOW_READ  = 3003,
    NEU_ERR_DEVICE_TAG_NOT_ALLOW_WRITE = 3004,

    NEU_ERR_DEVICE_OPCUA_ABNORMALITY        = 3100,
    NEU_ERR_DEVICE_OPCUA_TAG_TYPE_NOT_MATCH = 3101,
    NEU_ERR_DEVICE_OPCUA_TAG_NOT_EXIST      = 3102,
