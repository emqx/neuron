...
typedef enum {
    ...
    NEU_ERR_GROUP_ALREADY_SUBSCRIBED = 2105,
    NEU_ERR_GROUP_NOT_SUBSCRIBE      = 2016,
    NEU_ERR_GROUP_NOT_ALLOW          = 2017,
    NEU_ERR_GROUP_EXIST              = 2018,
    NEU_ERR_GROUP_PARAMETER_INVALID  = 2019,
    NEU_ERR_GROUP_NOT_EXIST          = 2020,
