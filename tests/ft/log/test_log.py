...
class TestLog:
    ...
    def test_change_log_level_debug(self):
        response = api.add_node(node='modbus-tcp-1', plugin=modbus_tcp)
        ...
        response = api.get_nodes_state()
        assert 200 == response.status_code
        assert "debug" == response.json()['states'][0]['log_level']
    ...
    def test_change_log_level_info(self):
        ...
        response = api.get_nodes_state()
        assert 200 == response.status_code
        assert "info" == response.json()['states'][0]['log_level']
    ...
    def test_change_log_level_warn(self):
        ...
        response = api.get_nodes_state()
        assert 200 == response.status_code
        assert "warn" == response.json()['states'][0]['log_level']
    ...
    def test_change_log_level_error(self):
        ...
        response = api.get_nodes_state()
        assert 200 == response.status_code
        assert "error" == response.json()['states'][0]['log_level']
    ...
    def test_change_log_level_fatal(self):
        ...
        response = api.get_nodes_state()
        assert 200 == response.status_code
        assert "fatal" == response.json()['states'][0]['log_level']
    ...
    def test_change_log_level_notice(self):
        ...
        response = api.get_nodes_state()
        assert 200 == response.status_code
        assert "notice" == response.json()['states'][0]['log_level']
