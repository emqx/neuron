...
class TestPlugin:
    ...
    with open('build/tests/plugins/libplugin-c1.so', 'rb') as f:
        test_data['so_file_c1'] = str(base64.b64encode(f.read()),encoding='utf-8')
    with open('build/tests/plugins/libplugin-c1_2.so', 'rb') as f:
        test_data['so_file_c1_2'] = str(base64.b64encode(f.read()),encoding='utf-8')
    with open('build/tests/plugins/libplugin-s1.so', 'rb') as f:
        test_data['so_file_s1'] = str(base64.b64encode(f.read()),encoding='utf-8')
    with open('build/tests/plugins/libplugin-s1_2.so', 'rb') as f:
        test_data['so_file_s1_2'] = str(base64.b64encode(f.read()),encoding='utf-8')  
    with open('build/tests/plugins/libplugin-sc1.so', 'rb') as f:
        test_data['so_file_sc1'] = str(base64.b64encode(f.read()),encoding='utf-8')
    with open('build/tests/plugins/libplugin-sc1_2.so', 'rb') as f:
        test_data['so_file_sc1_2'] = str(base64.b64encode(f.read()),encoding='utf-8')
    with open('build/tests/plugins/schema/c1.json', 'rb') as f:
        test_data['schema_file'] = str(base64.b64encode(f.read()),encoding='utf-8')  
    ...
    def test_01_add_plugin_fail0(self):
        ...
        response = api.add_plugin(library_name=plugin_data['library'],so_file=plugin_data['so_file'], schema_file=plugin_data['schema_file'])
    ...
    def test_04_add_plugin_fail5(self):
        ...
        response = api.add_plugin(library_name=plugin_data['library'],so_file=plugin_data['so_file'], schema_file=plugin_data['schema_file'])
        assert 400 == response.status_code
        assert NEU_ERR_LIBRARY_MODULE_ALREADY_EXIST == response.json().get("error")
    ...
    def test_07_update_plugin_fail0(self):
        ...
        response = api.updata_plugin(library_name=plugin_data['library'],so_file=plugin_data['so_file'], schema_file=plugin_data['schema_file'])
        assert 400 == response.status_code
    ...
    def test_18_add_template_success(self):
        ...
        response = api.add_template(name=template_data['name'], plugin=template_data['plugin'], groups=template_data['groups'])
        assert 200 == response.status_code
        assert NEU_ERR_SUCCESS == response.json().get("error")
