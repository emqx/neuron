...
*** Test Cases ***
Read/Write a point in the hold reg or coil area, and the data as bit/int16/uint16/int32/uint32/float/string type, it should return success
    ...
    ${test_node_id}    ${test_node_name}                                              tag_string    ${group}    ${tag_string}    hold reg    string    Neuron
