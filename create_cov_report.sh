...
case $1 in
    (modbus)
        ...
        cd cov_report
        lcov -a cov-neuron-base.info -a cov-neuron.info -a cov-restful.info -a cov-modbus-rtu.info -a cov-modbus-tcp.info -o cov-modbus.info;;
    (core)
        lcov -c -d build/CMakeFiles/neuron-base.dir/src -o cov_report/cov-neuron-base.info
        lcov -c -d build/CMakeFiles/neuron.dir/src -o cov_report/cov-neuron.info
        lcov -c -d build/CMakeFiles/neuron.dir/plugins/restful -o cov_report/cov-restful.info
    ...
    (metrics)
        ...
        lcov -c -d build/CMakeFiles/neuron.dir/plugins/restful -o cov_report/cov-restful.info
        cd cov_report
        lcov -a cov-neuron-base.info -a cov-neuron.info -a cov-restful.info -o cov-metrics.info;;
        (*)
